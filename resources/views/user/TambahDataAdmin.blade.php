            ...
            <div class="x_content">
              {!!Form::open(['url'=>route('submitTambahDataAdmin'),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control col-md-12 col-xs-12" name="username" value="{{old('username')}}" required pattern="^[A-Za-z0-9_.,]{6,}$" title="Input tidak menggunakan spasi">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-12">
