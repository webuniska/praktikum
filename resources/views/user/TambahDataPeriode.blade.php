              ...
              {!! Form::open(['url'=>route('submitTambahDataPeriode'),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control col-md-12 col-xs-12" name="namaperiode" required pattern="[/a-zA-Z0-9\s]+" title="Format penulisan periode yang benar, contoh : 2018/2019 Ganjil">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-12">
