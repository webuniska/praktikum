      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              {!!Form::open(['url'=>route('TambahDataMahasiswa'),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <label class="control-label text-left col-md-5 col-sm-7 col-xs-12">
                      Maksimal foto yang di upload berukuran 2 MB.
                  </label>
                </div>
                <hr>
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control col-md-12 col-xs-12" name="username" value="{{old('username')}}" required pattern="^[A-Za-z0-9]{6,}$" title="Input tidak menggunakan spasi, simbol dan dan minimal 6 karakter">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-12">
